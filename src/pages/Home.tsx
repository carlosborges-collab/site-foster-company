              ...
              <AnimatedSection delay={200}>
                <div className="w-full bg-f-black border border-f-neon/20 rounded-2xl p-6 shadow-2xl transform transition-transform duration-700 hover:rotate-x-2 hover:-rotate-y-2">
                  ...
                  <div className="space-y-4 mb-6 font-body text-[13px]">
                    ...
                    <div className="flex justify-start"><div className="flex gap-3 max-w-[90%]"><div className="w-6 h-6 rounded-full bg-f-neon/20 flex items-center justify-center shrink-0 mt-1"><span className="text-f-neon text-[10px]">✦</span></div><div className="bg-f-dark/80 text-f-mint rounded-2xl rounded-tl-sm px-4 py-3 border border-f-neon/10"><p className="mb-2">Aqui está o roteiro otimizado para retenção:</p><div className="font-mono text-[11px] text-f-neon/80 bg-f-black p-2 rounded border border-f-neon/20">[0:00-0:03] HOOK: "Sua agência está mentindo para você..."</div></div></div></div>
                  </div>
                </div>
              </AnimatedSection>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-f-black/60 backdrop-blur-md border border-f-neon/15 rounded-2xl p-8 hover:border-f-neon/50 hover:-translate-y-1 hover:glow-neon transition-all duration-300 h-full flex flex-col">
                ...
                <div className="flex flex-col gap-2 mb-8">
                  <div className="flex items-start gap-2 text-[12px] text-f-mint/80">
                    ...
                    <span><strong>Inteligência de Nicho:</strong> Descobre vídeos em alta e lacunas de conteúdo.</span>
                  </div>
                  <div className="flex items-start gap-2 text-[12px] text-f-mint/80">
                    <span className="text-f-neon mt-1">▸</span>
                    <span><strong>Otimizador de Vídeo:</strong> Gera títulos de alto CTR e SEO a partir de URLs.</span>
                  </div>
                  <div className="flex items-start gap-2 text-[12px] text-f-mint/80">
                    <span className="text-f-neon mt-1">▸</span>
                    <span><strong>Mineração de Canais:</strong> Identifica canais em crescimento acelerado.</span>
                  </div>
                </div>
            ...
            <AnimatedSection delay={100}>
              <div className="bg-f-black/60 backdrop-blur-md border border-f-neon/15 rounded-2xl p-8 hover:border-f-neon/50 hover:-translate-y-1 hover:glow-neon transition-all duration-300 h-full flex flex-col">
                ...
                <p className="text-f-mint/60 text-[14px] leading-[1.55] mb-6 flex-grow">
                  A plataforma inteligente de registro de marcas do Brasil. Pesquise o nome da sua marca e receba uma análise baseada na base histórica do INPI com chances reais de aprovação.
                </p>

                <div className="flex flex-col gap-2 mb-8">
                  <div className="flex items-start gap-2 text-[12px] text-f-mint/80">
                    <span className="text-f-neon mt-1">▸</span>
                    <span><strong>Score de Viabilidade:</strong> Saiba suas chances reais antes de investir.</span>
                  </div>
                  <div className="flex items-start gap-2 text-[12px] text-f-mint/80">
                    <span className="text-f-neon mt-1">▸</span>
                    <span><strong>Base INPI Atualizada:</strong> Pesquise contra dados reais semanais.</span>
                  </div>
                  <div className="flex items-start gap-2 text-[12px] text-f-mint/80">
                    <span className="text-f-neon mt-1">▸</span>
                    <span><strong>Gestão Completa:</strong> Acompanhe seu registro em um dashboard próprio.</span>
                  </div>
                </div>
            ...
            <AnimatedSection delay={200}>
              <div className="bg-f-black/60 backdrop-blur-md border border-f-neon/15 rounded-2xl p-8 hover:border-f-neon/50 hover:-translate-y-1 hover:glow-neon transition-all duration-300 h-full flex flex-col">
                ...
                <p className="text-f-mint/60 text-[14px] leading-[1.55] mb-6 flex-grow">
                  A plataforma onde experts criam seu clone digital com IA e passam a atender, educar e engajar seu público 24 horas por dia — sem precisar estar disponível.
                </p>

                <div className="flex flex-col gap-2 mb-8">
                  <div className="flex items-start gap-2 text-[12px] text-f-mint/80">
                    <span className="text-f-neon mt-1">▸</span>
                    <span><strong>Clone Digital:</strong> Sua personalidade e tom de voz em um clone.</span>
                  </div>
                  <div className="flex items-start gap-2 text-[12px] text-f-mint/80">
                    <span className="text-f-neon mt-1">▸</span>
                    <span><strong>Bio Link Inteligente:</strong> Perfil público com link único para redes.</span>
                  </div>
                  <div className="flex items-start gap-2 text-[12px] text-f-mint/80">
                    <span className="text-f-neon mt-1">▸</span>
                    <span><strong>Painel de Gestão:</strong> Acompanhe conversas e base de conhecimento.</span>
                  </div>
                </div>
